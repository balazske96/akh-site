...
export default function SocialMediaIconContainer(): ReactElement {
    ...
    return (
        <div className={styles.container}>
            ...
            <img className={computedInstagramClassName} src="/social/instagram.png" onClick={() => onSocialIconClick(SocialMedia.Instagram)} />
            <img className={computedYoutubeClassName} src="/social/youtube.png" onClick={() => onSocialIconClick(SocialMedia.Youtube)} />
        </div>
    )
}