...
$images = [
    ...
    get_stylesheet_directory_uri() . '/images/section-1-image-3',
    get_stylesheet_directory_uri() . '/images/section-1-image-4',
...
$videos = [
    get_stylesheet_directory_uri() . '/videos/audience-hands.webm',
];
...
<body>
    ...
    <section>
        <div class="relative mx-auto">
            <div class="flex justify-center xl:hidden" aria-hidden>
            ...
            <h1 class="font-extrabold text-center leading-[14.33vw] text-[11.94vw] xl:text-[2.66vw] xl:leading-[3.125vw] uppercase xl:ml-[-6vw]">
                Hallgasd<br>ahogy<br>átcsempész
            </h1>
            <div class="hidden xl:block w-max mr-auto ml-[46.5vw] mt-[1.3125rem]">
            ...
            <div class="flex justify-center mt-[15.27vw] xl:hidden">
            ...
            <!-- Relative images -->
            <img class="
                    w-[77.22vw] xl:w-[16.14vw] h-auto absolute
                    right-[50%] xl:right-auto xl:left-[16.14vw]
                    xl:translate-x-0 translate-x-1/2 top-[112.5vw] xl:top-0
                " src="<?php echo $images[1] ?>" alt="">
            <img class="absolute left-0 xl:left-[11.04vw] w-[61.66vw] xl:w-[16.77vw] h-auto top-[176.09vw] xl:top-[16.45vw]" src="<?php echo $images[0] ?>" alt="">
            <!-- Relative text -->
            <div class="absolute top-[246.38vw] xl:top-[22.91vw] right-[55%] xl:right-auto xl:left-[29.63vw] translate-x-1/2 xl:translate-x-0 w-max xl:max-w-max">
                <p class="text-[7vw] xl:text-[1.4vw] leading-[6.82vw] xl:leading-[1.29vw] font-handwritten">Épp, hogy megjöttél</p>
                <div class="xl:flex-row xl:flex">
                    <p class="text-[7vw] xl:text-[1.4vw] leading-[6.82vw] xl:leading-[1.29vw] ml-[19vw] xl:ml-0 font-handwritten">szárnyat bontott </p>
                    <p class="text-[7vw] xl:text-[1.4vw] leading-[6.82vw] xl:leading-[1.29vw] ml-[53vw] xl:ml-0 font-handwritten">a tél...</p>
                </div>
            </div>
            <!-- Relative images -->
            <picture>
                <source media="(max-width: 1279px)" srcset="<?php echo $images[2] ?>-mobile.webp">
                <source media="(min-width: 1280px)" srcset="<?php echo $images[2] ?>-desktop.webp">
                <img class="absolute w-[102.49vw] h-auto left-[-10.27vw] top-[271.11vw]
                            xl:w-[21.875vw] xl:left-auto xl:right-[16.14vw] xl:top-0
                        " src="<?php echo $images[2] ?>-mobile.webp" alt="">
            </picture>

            <picture>
                <source media="(max-width: 1279px)" srcset="<?php echo $images[3] ?>-mobile.webp">
                <source media="(min-width: 1280px)" srcset="<?php echo $images[3] ?>-desktop.webp">
                <img class="
                        absolute w-[48.05vw] xl:w-[19.11vw] xl:right-[13.125vw] h-auto right-0 top-[316.38vw] xl:top-[25.31vw]"
                    src="<?php echo $images[3] ?>-mobile.webp" alt="">
            </picture>
            <!-- Relative text / Desktop only -->
            <div class="hidden xl:flex flex-row items-end absolute top-[32.23vw] left-[54.27vw]">
                <div>
                    <span class="text-[1.4vw] font-handwritten leading-[1.29vw]">Bárcsak itt lennél,<br>örökkön örökké...</span>
                </div>
                <div class="flex pb-[7px] ml-[-10px]">
    ...
    <?php } ?>
    <section>
        <div class="relative pt-[185.44vw]">
            ...
            <div id="koncertek" class="absolute mx-auto z-50 w-[80.55vw] h-[80.55vw] left-[50%] translate-x-[-50%] top-[123.88vw] overflow-hidden">
                ...
                <video class="absolute top-0 left-0 h-full w-auto object-cover z-10" autoplay muted loop>
                    <source type="video/mp4" src="<?php echo $videos[0] ?>">
                </video>
            </div>
            <?php if ($are_there_any_concert) { ?>
    ...
    <section class="pt-[150vw] relative">
        ...
        <!-- Quote -->
        <div id="webshop" class="absolute top-[102vw] left-[1vw]">
