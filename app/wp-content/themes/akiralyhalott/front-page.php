...
<body class="mx-auto bg-[var(--smoke-white)]">
    ...
    <section>
        <div class="text-center relative">
            ...
            <!-- Relative texts -->
            <span class="absolute font-handwritten text-[0.9375vw] left-[29.63%] top-[22.91vw] text-left">Épp, hogy megjöttél,<br>szárnyat bontott a tél...</span>
            <div class="absolute w-max left-[59.27%] top-[32.23vw]">
                <span class="font-handwritten text-[0.9375vw] text-left inline-block">Bárcsak itt lennél,<br>örökkön örökké...</span>
                <svg class="inline-block ml-[-8px] mb-[-5px]" width="8" height="6" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
