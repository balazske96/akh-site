...
<body class="mx-auto bg-[var(--smoke-white)]">
    ...
    <section>
        <div class="text-center relative">
            <div class="ml-[-6vw]">
                <h1 class="text-[3.4895vw]">Lorem<br>ipsum dolor<br>sit amet</h1>
                <h2 class="text-[1.0416vw] uppercase">Lorem ipsum dolor sit amet</h2>
            </div>
            <!-- Mouse Icon -->
            <div class="w-max mr-auto ml-[46.5vw] mt-[1.3125rem]">
                <svg width="18" height="156" viewBox="0 0 18 156" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_233_2)">
                        <path
                            d="M8.23922 141.92H9.79922C13.1192 141.92 15.7992 139.2 15.7992 135.88V125.72C15.7992 122.4 13.0792 119.68 9.75922 119.68H8.19922C4.87922 119.68 2.19922 122.4 2.19922 125.72V135.88C2.19922 139.2 4.87922 141.92 8.23922 141.92ZM3.39922 125.72C3.39922 123.04 5.55922 120.88 8.23922 120.88H9.79922C12.4792 120.88 14.6392 123.04 14.6392 125.72V135.88C14.6392 138.56 12.4792 140.72 9.79922 140.72H8.23922C5.55922 140.72 3.39922 138.56 3.39922 135.88V125.72Z"
                            fill="black" />
                        <path
                            d="M9.00039 138.36C9.32039 138.36 9.60039 138.08 9.60039 137.76V135.48C9.60039 135.16 9.32039 134.88 9.00039 134.88C8.68039 134.88 8.40039 135.16 8.40039 135.48V137.76C8.40039 138.12 8.68039 138.36 9.00039 138.36Z"
                            fill="black" />
                        <path
                            d="M11.1156 151.605L9.52018 153.215V148.525C9.52018 148.245 9.27748 148 8.99998 148C8.72248 148 8.47977 148.245 8.47977 148.525V153.25L6.88438 151.605C6.67628 151.395 6.36418 151.395 6.15608 151.605C5.94797 151.815 5.94797 152.13 6.15608 152.34L8.65318 154.86C8.68788 154.895 8.75717 154.965 8.82657 154.965C8.89597 155 8.96528 155 8.99998 155C9.03468 155 9.13868 155 9.17338 154.965C9.24278 154.93 9.31208 154.895 9.34678 154.86L11.8439 152.34C12.052 152.13 12.052 151.815 11.8439 151.605C11.6358 151.395 11.3237 151.43 11.1156 151.605Z"
                            fill="black" />
    ...
    if ($are_there_any_concert) { ?>
        <!-- YouTube Video -->
        <section class="mt-[16.51vw] relative h-[27.55vw]">
            <iframe class="absolute w-[49.06%] h-[27.55vw] top-0 left-[14.79%]" width="560" height="315"
                src="https://www.youtube.com/embed/A99MKasrGzk?si=dFaVgWL6IxPRwYKH" title="YouTube video player"
                frameborder="0"
    ...
    ?>
    <section class="relative min-h-[57.86vw]">
        <img class="absolute top-[11.25vw] left-[9.27%] w-[34.63%] h-[40.62vw] z-10" src="<?php echo $images[4] ?>" alt="">
        <span class="absolute text-[1.5vw] text-white font-handwritten left-[11.09%] top-[48.02vw] z-20">Ezt az éjszakát is követeli a
            hajnal...</span>
        <div
            class="absolute flex items-center justify-center w-[21.35%] h-[21.875vw] overflow-hidden top-[4.21vw] left-[26.82%] z-20">
            <p class="text-white text-[3.4895vw] z-30 text-center">
                Lorem ipsum dolor mit amet
            </p>
            <video class="absolute h-full w-auto object-cover" autoplay muted loop>
                <source type="video/mp4"
                    src="https://s3-figma-videos-production-sig.figma.com/video/1069926685023483013/TEAM/ae70/66ba/-bd83-4027-9ac0-281e494834ad?Expires=1725235200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=GW0~1tb7UZrxw09AgwtkSAGtgQWKhusCi-veVAF72JFCmTWBeZ0vdNA90z9QpdRfpMrwbVWdWRwNudUdOuGFhcY2Dat0HLjg7FZY4U0bjcHD2TjG7VKYeKiy02E9BmL1-0rfBCdpLFo4zh2SigHIgGlsG7~2JLMwjgN~eD2eDeqIyjxWWD7ZJQYV2pXCcJYD~1rZqoUZeKPg7aJ0QJp7EHJLRPopq7PpH6fZQq~6ujJGmr1BZb1mpkTdp91Net64GOdiRPv2NHZRTun38imRSRcWHF6x4LshBqo06OvZpjjrwfA3ax-lMdehG6IrSKmdy6OUugr8aWMqx0JH5g042Q__">
            </video>
        </div>

        <?php
        if ($are_there_any_concert) { ?>
            <div class="absolute flex flex-col bg-white w-[48.90%] h-[42.08vw] left-[41.04%] top-[15.78vw] p-[5.36vw]">
                <a href="#" class="w-full flex justify-end items-center gap-[1.0416vw] mb-[2.1875vw]">
                    <span class="ml-auto inline text-[0.7812vw]">Összes koncert dátum</span>
                    <svg class="inline" width="35" height="9" viewBox="0 0 35 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <?php foreach ($concerts as $concert) { ?>
                    <div class="flex w-full justify-between items-center py-[1.5625vw]
                            [&:not(:last-child)]:border-b-2 [&:not(:last-child)]:border-black gap-8">
                        <date class="text-[0.5729vw]"><?php echo $concert['date'] ?></date>
                        <p class="flex-1 text-[1.25vw] text-left"><?php echo $concert['city'] ?></p>
                        <span class="flex-1 text-[0.5729vw] text-right"><?php echo $concert['venue'] ?></span>
                        <a class="text-right underline text-[0.7812vw]" href="#link">JEGYEK</a>
                    </div>
                <?php } ?>
            </div>
        <?php
    ...
    <section class="relative min-h-[39.11vw]">
        <img class="absolute w-[27.65%] h-[16.875vw] top-[-7.55vw] left-[55.20%]" src="<?php echo $images[5] ?>" alt="">
        <img class="absolute w-[16.25%] h-[21.875vw] top-[3.59vw] left-[64.16%]" src="<?php echo $images[6] ?>" alt="">
        <img class="absolute w-[3.4375vw] h-[5.8333vw] top-[5.2604vw] left-[53.0208%]" src="<?php echo $images[7] ?>" alt="">
        <img class="absolute w-[12.1875vw] h-[4.1666vw] top-[12.7947vw] left-[50.0260vw] rotate-[-21.65deg]" src="<?php echo $images[8] ?>" alt="">
        <p class="absolute text-[1.5vw] top-[11.125vw] left-[41.93vw] font-handwritten">
            Termék vagyok, leszek, voltam<br>Ha egy valamit,<br>ezt megtanultam
        </p>
        <div id="webshop" class="absolute w-[28.8020vw] h-[40vw] flex flex-col left-[16.7187vw] top-[-3.1770vw]">
            <div id="preview-container">
                <img id="preview-image" src="<?php echo $webshop_products[0]['image']  ?>" class="w-full object-cover">
            </div>
            <div id="title-container" class="">
                <p class="text-[1.8229vw] text-center">
                    <?php echo $webshop_products[0]['name']  ?>
                </p>
            </div>
            <div id="price-container">
                <p class="text-[0.625vw] text-center">
                    <?php echo $webshop_products[0]['price']  ?> Ft
                </p>
            </div>
            <div id="carousel" class="flex">
                <button id="left-arrow-container">
                    <svg class="hover:opacity-50 rotate-180 w-[1.3541vw] h-[1.3541vw]" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="overflow-hidden"> // Carousel kód nézése a neten és overflow megoldása
                    <?php

                    foreach ($webshop_products as $product) {
                        render_product_carousel($product);
                    }

                    ?>
                </div>
                <button id="right-arrow-container">
                    <svg class="hover:opacity-50 w-[1.3541vw] h-[1.3541vw]" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="13" cy="13" r="12.5" stroke="black" />
                        <path d="M7 12.5C6.72386 12.5 6.5 12.7239 6.5 13C6.5 13.2761 6.72386 13.5 7 13.5L7 12.5ZM19.3536 13.3536C19.5488 13.1583 19.5488 12.8417 19.3536 12.6464L16.1716 9.46447C15.9763 9.2692 15.6597 9.2692 15.4645 9.46447C15.2692 9.65973 15.2692 9.97631 15.4645 10.1716L18.2929 13L15.4645 15.8284C15.2692 16.0237 15.2692 16.3403 15.4645 16.5355C15.6597 16.7308 15.9763 16.7308 16.1716 16.5355L19.3536 13.3536ZM7 13.5L19 13.5L19 12.5L7 12.5L7 13.5Z" fill="black" />
                    </svg>
                </button>
