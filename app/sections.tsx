export const Introduction = () => (
  <section>
    <div className="relative mx-auto">
      ...
      <h1 className="font-extrabold text-center leading-[14.33vw] text-[11.94vw] xl:text-[2.66vw] xl:leading-[3.125vw] uppercase xl:ml-[-6vw]">
        Hallgasd
        <br />
        ahogy
        <br />
      ...
      <picture>
        <source
          media="(max-width: 1279px)"
          srcSet="<?php echo $images[3] ?>-mobile.webp"
        />
        <source
          media="(min-width: 1280px)"
          srcSet="<?php echo $images[3] ?>-desktop.webp"
        />
        <img
          className="
      ...
      <div className="hidden xl:flex flex-row items-end absolute top-[32.23vw] left-[54.27vw]">
        ...
        <div className="flex pb-[7px] ml-[-10px]">
          <svg
            width="16"
            height="12"
            viewBox="0 0 16 12"
...
export const Concerts = () => (
  <section>
    <div className="relative pt-[185.44vw]">
      ...
      >
        <h2 className="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] font-extrabold text-center leading-[14.33vw] text-[11.94vw] uppercase text-white z-20">
          Közelgő
          <br />
          koncert
          <br />
      ...
      <div className="flex flex-col justify-between pt-[35vw] pb-[14.16vw] bg-white px-[5vw] gap-[8.33vw]">
        <div className="flex justify-between">
          ...
          <div className="flex justify-center items-end">
            <a
              className="py-[2.77vw] px-[3.61vw] border-2 border-[#CDCDCD] rounded-[13.05vw]"
              href="#link"
            >
              JEGYEK
            </a>
  ...
  <section className="pt-[150vw] relative">
    ...
    <div className="pb-[8vw]">
      <a href="<?php echo $webshop_products[0]['link'] ?>" id="product-link">
        <div>
          <img
            ...
            src="<?php echo $webshop_products[0]['image']  ?>"
          />
        </div>
        <div>
          <p
      ...
      <div id="webshop-slider" className="mt-[2vw]">
        ...
        >
          <button
            className="glide__arrow glide__arrow--left rotate-180"
            data-glide-dir="<"
          >
            <svg
          ...
          <div className="glide__track relative" data-glide-el="track">
            ...
            <div className="absolute top-0 right-0 mr-[-7px] w-[15vw] h-[100%] webshop-carousel-fade"></div>
          </div>
          <button
...
export const Music = () => (
  <section className="relative pt-[59.44vw]" id="zene">
    <img
      ...
      src="<?php echo $images[9] ?>"
      alt=""
    />
    <div className="shadow-spotify-iframe max-w-max mx-auto rounded-[12px]">
      <iframe
        className="w-[90vw] h-[94vw] mx-auto mb-[90.27vw] z-10 relative"
    ...
    <img
      ...
      src="<?php echo $images[10] ?>"
      alt=""
    />
    <div className="grid grid-cols-2 gap-x-10 gap-y-7 px-6 mb-5">
      <a
        className="flex justify-center items-center"
        href="<?php echo $platform['link'] ?>"
        target="_blank"
      >
        <img
          src="<?php echo $platform['image_src'] ?>"
          alt="<?php echo $platform['name'] ?> logo"
        />
      </a>
    </div>
  </section>
